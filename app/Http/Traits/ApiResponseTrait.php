...
trait ApiResponseTrait
{
    ...
    {
        return $this->apiResponse(['success' => true, 'message' => $message, 'result' => $data], 201);
    }
    ...
    {
        return $this->apiResponse(['success' => true, 'message' => $message], 204);
    }
     ...
     * @return JsonResponse
     */
    protected function respondUnAuthenticated($message = 'Unauthenticated')
    {
